<div class="py-8 min-h-screen text-fg bg-transparent">
                ...
                <div
                    ...
                    <div
                        ...
                        <button wire:click="$set('activeTab', 'security')" type="button"
                            ...
                            <svg class="w-4 h-4 lg:w-5 lg:h-5 flex-shrink-0 {{ $activeTab === 'security' ? 'text-fg' : 'text-fg-muted' }}"
                        ...
                        <button wire:click="$set('activeTab', 'work_hours')" type="button"
                            ...
                            <svg class="w-4 h-4 lg:w-5 lg:h-5 flex-shrink-0 {{ $activeTab === 'work_hours' ? 'text-fg' : 'text-fg-muted' }}"
                                fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        ...
                        <button wire:click="$set('activeTab', 'permission_rules')" type="button"
                            ...
                            <svg class="w-4 h-4 lg:w-5 lg:h-5 flex-shrink-0 {{ $activeTab === 'permission_rules' ? 'text-fg' : 'text-fg-muted' }}"
                                fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        ...
                        <button wire:click="$set('activeTab', 'company')" type="button"
                            ...
                            <svg class="w-4 h-4 lg:w-5 lg:h-5 flex-shrink-0 {{ $activeTab === 'company' ? 'text-fg' : 'text-fg-muted' }}"
                                fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        ...
                        <button wire:click="$set('activeTab', 'branches')" type="button"
                            ...
                            <svg class="w-4 h-4 lg:w-5 lg:h-5 flex-shrink-0 {{ $activeTab === 'branches' ? 'text-fg' : 'text-fg-muted' }}"
                                fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        ...
                        <button wire:click="$set('activeTab', 'biometrics')" type="button"
                            class="px-3.5 py-2.5 lg:px-4 lg:py-3 label-xs font-bold rounded-xl lg:rounded-xl transition-all flex flex-col lg:flex-row items-center justify-center lg:justify-start gap-1.5 lg:gap-2 text-center lg:text-left flex-shrink-0 min-h-[68px] lg:min-h-0 {{ $activeTab === 'biometrics' ? 'tab-active' : 'text-fg-muted hover:text-fg hover:bg-surface-muted bg-surface-muted lg:bg-transparent border border-border lg:border-0' }}">
                            <svg class="w-4 h-4 lg:w-5 lg:h-5 flex-shrink-0 {{ $activeTab === 'biometrics' ? 'text-fg' : 'text-fg-muted' }}"
                                fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        ...
                        <button wire:click="$set('activeTab', 'roles')" type="button"
                            ...
                            <svg class="w-4 h-4 lg:w-5 lg:h-5 flex-shrink-0 {{ $activeTab === 'roles' ? 'text-fg' : 'text-fg-muted' }}"
                                fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                @if ($activeTab === 'biometrics')
                    <div
                        ...
                        <div class="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
                            <div
                                class="bg-surface-muted border border-border rounded-xl p-4 sm:p-5 relative overflow-hidden">
                        ...
                        <div
                            class="bg-surface-muted border border-border rounded-xl p-4 mb-6 grid grid-cols-1 md:grid-cols-3 gap-4">
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    @if ($search)
                                        <button @click="$wire.set('search', '')"
                                            class="absolute right-2.5 top-1/2 -translate-y-1/2 text-fg-muted hover:text-fg text-xs">×</button>
                                    @endif
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <select wire:model.live="statusFilter"
                                    class="w-full text-xs cursor-pointer">
                                    <option value="all" class="bg-surface">Semua Karyawan</option>
                                    <option value="registered" class="bg-surface">Wajah Terverifikasi (Aktif)
                                    </option>
                                    <option value="pending" class="bg-surface">Belum Registrasi Wajah</option>
                                </select>
                            </div>
                            ...
                            <div>
                                ...
                                <select wire:model.live="branchFilter"
                                    class="w-full text-xs cursor-pointer">
                                    <option value="all" class="bg-surface">Semua Cabang</option>
                                    @foreach ($branches as $b)
                                        <option value="{{ $b->id }}" class="bg-surface">{{ $b->name }}
                                        </option>
                                    @endforeach
                                </select>
                            </div>
                        ...
                        <div class="border border-border rounded-xl overflow-hidden bg-surface-muted">
                                    ...
                                    <tbody class="divide-y divide-border font-medium text-fg-muted">
                                        @forelse($users as $u)
                                            <tr class="hover:bg-surface-muted transition-colors">
                                                <td class="px-5 py-4">
                                                    <div class="flex items-center space-x-3.5">
                                                        @if ($u->hasRegisteredFace())
                                                            <div
                                                                class="relative w-9 h-9 rounded-xl border border-border overflow-hidden bg-surface-muted flex-shrink-0">
                                                                <img src="{{ $u->getMasterFaceUrl() }}"
                                                                    class="w-full h-full object-cover -scale-x-100">
                                                            </div>
                                                        @else
                                                            <div
                                                                class="w-9 h-9 rounded-xl bg-surface-muted border border-border flex items-center justify-center font-bold text-fg-muted flex-shrink-0">
                                                                {{ strtoupper(substr($u->name, 0, 1)) }}
                                                            </div>
                                                        @endif
                                                        <div>
                                                            <span
                                                                class="label-sm font-bold text-fg block whitespace-nowrap">{{ $u->name }}</span>
                                                            <span
                                                                class="label-xs text-fg-subtle block mt-0.5 font-medium whitespace-nowrap">#{{ $u->employee_id }}
                                                ...
                                                <td class="px-5 py-4">
                                                    <span
                                                        class="label-sm font-bold text-fg block whitespace-nowrap">{{ $u->branch->name ?? 'Belum Ditentukan' }}</span>
                                                ...
                                                <td class="px-5 py-4 text-center">
                                                    @if ($u->is_registered)
                                                        <span class="badge-success whitespace-nowrap">
                                                            <span
                                                                class="w-1.5 h-1.5 rounded-full bg-success mr-1.5"></span>
                                                            Kunci Aktif
                                                        </span>
                                                    @else
                                                        <span class="badge-danger whitespace-nowrap">
                                                            <span
                                                                class="w-1.5 h-1.5 rounded-full bg-danger mr-1.5"></span>
                                                            Belum Terdaftar
                                                        </span>
                                                    @endif
                                                </td>
                                                ...
                                                <td class="px-5 py-4 text-center text-xs">
                                                    @if ($u->is_registered)
                                                        <div class="flex items-center justify-center space-x-1">
                                                            <span
                                                                class="label-xs font-bold text-primary mr-1.5">{{ $u->registered_angles }}/3</span>
                                                            <span
                                                                class="w-2 h-2 rounded-full {{ $u->registered_angles >= 1 ? 'bg-primary' : 'bg-surface-muted' }}"
                                                                title="Sudut Tengah"></span>
                                                            <span
                                                                class="w-2 h-2 rounded-full {{ $u->registered_angles >= 2 ? 'bg-info' : 'bg-surface-muted' }}"
                                                                title="Profil Kiri"></span>
                                                            <span
                                                                class="w-2 h-2 rounded-full {{ $u->registered_angles >= 3 ? 'bg-success' : 'bg-surface-muted' }}"
                                        ...
                                        @empty
                                            <tr>
                                                <td colspan="5"
                                                    class="px-5 py-12 text-center text-fg-subtle font-bold tracking-wider">
                                                    <svg class="w-8 h-8 mx-auto mb-2 text-fg-subtle" fill="none"
                                                        stroke="currentColor" viewBox="0 0 24 24">
                                                        <path stroke-linecap="round" stroke-linejoin="round"
                                                            stroke-width="2"
                            ...
                            <div class="md:hidden divide-y divide-border">
                                    ...
                                    <div class="p-4">
                                        ...
                                        <div class="mt-3 grid grid-cols-2 gap-2">
                                            <div>
                                                ...
                                                <div class="label-sm font-semibold text-fg truncate">{{ $u->branch->name ?? 'Belum Ditentukan' }}</div>
                                ...
                                @empty
                                    <div class="px-5 py-12 text-center text-fg-subtle font-bold tracking-wider label-xs">
                                        Tidak ada data karyawan yang cocok dengan kriteria pencarian Anda.
                                    </div>
                                @endforelse
                            </div>
        ...
        <div @click.away="open = false"
            ...
            <div class="flex items-center justify-between mb-6 border-b border-border pb-4">
                <h3 class="heading-3 flex items-center">
                    <svg class="w-4 h-4 mr-1.5 inline-block text-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div x-data="{ open: @entangle('showUserEditModal') }" x-show="open"
        ...
        <div @click.away="open = false"
            class="w-full max-w-3xl my-auto rounded-xl relative overflow-hidden modal-glass"
            x-transition:enter="transition ease-out duration-200"
            ...
            <form wire:submit.prevent="saveUser" class="px-6 sm:px-8 py-6 space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-12 gap-6">
                    ...
                    <div class="md:col-span-4 flex flex-col items-center">
                        ...
                        @else
                            <div
                                class="relative w-full aspect-square max-w-[180px] bg-surface-muted border border-border rounded-xl overflow-hidden flex items-center justify-center shadow-md">
                                <div class="text-center text-fg-subtle p-4">
                                    ...
                                    <span class="label-xs text-fg-subtle block">Wajah Belum Terdaftar</span>
                                </div>
                            </div>
                        @endif
                    </div>
                ...
                <div class="border-t border-border pt-4">
                    <span class="block label-xs mb-2.5"><svg class="w-5 h-5 mr-2 text-fg-muted inline-block"
                            fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    @if (empty($userDevices))
                        <div
                            class="bg-surface-muted border border-border rounded-xl p-4 text-center label-xs font-bold text-fg-subtle">
                            Tidak ada perangkat yang terdaftar atau digunakan karyawan ini.
                        </div>
                    @else
                        <div
                            class="max-h-[140px] overflow-y-auto space-y-2 pr-1.5 divide-y divide-border bg-surface-muted border border-border rounded-xl p-3 text-xs">
                            @foreach ($userDevices as $index => $device)
                                <div class="flex justify-between items-center pt-2 {{ $index === 0 ? 'pt-0' : '' }}">
                                    <div class="space-y-0.5">
                                        <div class="flex items-center space-x-2">
                                            <span
                                                class="label-sm font-bold text-fg">{{ $device['browser'] ?? 'Browser' }}
                ...
                <div class="pt-4 border-t border-border flex items-center justify-between">
                    <div class="flex items-center">
                        ...
                        <span class="ml-3 label-sm text-fg-muted">Akun Karyawan Aktif</span>
                    </div>
