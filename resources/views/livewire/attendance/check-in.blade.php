<div class="py-6 min-h-screen" x-data="checkInApp()" x-init="init()" x-on:destroy="destroy()">
    ...
    <div class="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-6">
            ...
            <p class="label-sm mt-1">Dekatkan wajah dan pastikan Anda berada di dalam area kantor untuk melakukan absen masuk.</p>
        </div>
            ...
            <div class="lg:col-span-5 order-1 lg:order-2 space-y-6">
                <div class="card p-5 space-y-5">
                    <div class="flex items-center justify-between border-b border-border pb-2.5">
                        ...
                        <span class="label-xs font-mono">Shift: Pagi</span>
                    </div>
                    ...
                    <div class="pt-3 border-t border-border flex justify-center">
                        <button x-show="$wire.locationValid && $wire.faceValid" x-cloak wire:click="submit" type="button" class="btn-success w-full">
    ...
    <div x-show="$wire.isSubmitting" x-cloak class="modal-overlay flex flex-col items-center justify-center z-50">
        ...
        <p class="text-sm text-slate-300 mt-1.5">Mengirim data kehadiran masuk Anda ke sistem…</p>
    </div>
