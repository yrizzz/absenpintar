                ...
                <div class="overflow-hidden rounded-xl border border-white/10 bg-[#121c32]/85 shadow-2xl relative">
                    ...
                    <div class="relative bg-slate-950 aspect-video flex items-center justify-center overflow-hidden">
                        ...
                        <div x-show="isAnalyzing" class="absolute inset-0 bg-transparent flex flex-col items-center justify-center z-20 pointer-events-none" style="display: none;">
                            ...
                            <div class="absolute top-3 right-3 bg-slate-900/80 border border-cyan-500/30 text-cyan-400 px-2.5 py-1 rounded-md text-[9px] font-bold tracking-wider flex items-center gap-1.5 shadow-lg">
