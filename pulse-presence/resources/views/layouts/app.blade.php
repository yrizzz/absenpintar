            ...
            <div class="mx-auto w-full max-w-7xl px-4 sm:px-6 lg:px-8 mt-6 relative z-10">
                @if (session('success'))
                    <div
                        ...
                        <span class="p-1.5 bg-emerald-600 rounded-full text-white flex-shrink-0 flex items-center justify-center">
                            <svg class="w-4 h-4" fill="none" stroke="#ffffff" style="color: #ffffff !important;" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M5 13l4 4L19 7" />
                            </svg>
                        </span>
                ...
                @if (session('error'))
                    <div
                        ...
                        <span class="p-1.5 bg-rose-600 rounded-full text-white flex-shrink-0 flex items-center justify-center">
                            <svg class="w-4 h-4" fill="none" stroke="#ffffff" style="color: #ffffff !important;" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                @if (session('warning'))
                    <div
                        ...
                        <span class="p-1.5 bg-amber-600 rounded-full text-white flex-shrink-0 flex items-center justify-center">
                            <svg class="w-4 h-4" fill="none" stroke="#ffffff" style="color: #ffffff !important;" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
