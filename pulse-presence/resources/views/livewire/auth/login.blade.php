<div class="min-h-screen flex flex-col lg:flex-row bg-[#081229] bg-gradient-to-br from-[#0c1b40] via-[#081229] to-[#030612] font-sans text-slate-200 relative overflow-hidden">
    ...
    <div class="hidden lg:flex lg:w-[45%] bg-[#081229]/65 border-r border-white/10 p-10 flex-col justify-between relative overflow-y-auto backdrop-blur-md">
        ...
        <div class="relative z-10 flex items-center space-x-6 text-xs text-slate-400">
            ...
            <div class="flex items-center space-x-1.5">
                <span class="w-1.5 h-1.5 rounded-full bg-emerald-500 animate-pulse"></span>
                <span class="font-medium">AI Core Online</span>
            </div>
        </div>
    </div>
        ...
        <div class="w-full max-w-[390px]">
            ...
            <div class="lg:hidden text-center mb-8">
                <div class="inline-flex items-center space-x-3 mb-1.5">
                    ...
                    <span class="text-2xl font-black text-white font-display">Absen<span class="text-blue-500">Pintar</span></span>
                </div>
            ...
            <div class="bg-slate-900/65 border border-white/15 rounded-2xl p-7 md:p-8 shadow-2xl backdrop-blur-2xl">
                ...
                <form wire:submit="login" class="space-y-5">
                    ...
                    <div class="space-y-1.5">
                        <div class="flex items-center justify-between">
                            ...
                            <a href="#" class="text-xs font-semibold text-blue-400 hover:text-blue-300 transition-colors">
                                Lupa sandi?
                            </a>
                        </div>
                    ...
                    <div class="flex items-center justify-between pt-1">
                        <label class="flex items-center cursor-pointer select-none">
                            <input wire:model="remember" id="remember" type="checkbox"
                                class="w-4 h-4 rounded border-white/10 bg-slate-950/50 text-blue-500 focus:ring-blue-500/20 focus:ring-offset-0 transition-colors">
                            <span class="ml-2 text-xs text-slate-400 hover:text-slate-200 transition-colors">Tetap masuk</span>
                        </label>
                    </div>
                    ...
                    <div class="pt-2">
                        <button type="submit" wire:loading.attr="disabled"
                            class="w-full py-2.5 bg-blue-600 hover:bg-blue-500 text-white font-bold text-sm rounded-xl shadow-lg shadow-blue-500/5 hover:shadow-blue-500/15 focus:outline-none focus:ring-4 focus:ring-blue-500/15 transition-all duration-200 flex items-center justify-center disabled:opacity-50 disabled:cursor-not-allowed">
                ...
                <!-- Small Grid of Clickable Badge Buttons (Enlarged and optimized for touch targets) -->
                ...
                <div class="flex items-center justify-center space-x-2 pt-4 border-t border-white/5 mt-4 text-xs">
                    <span class="text-slate-500 font-medium">Sandi default:</span>
                    <span class="font-mono font-bold text-blue-400 bg-blue-500/10 border border-blue-500/25 px-2 py-0.5 rounded-lg select-all">password</span>
                </div>
            </div>

            <!-- Footer -->
            <div class="text-center mt-8">
                <p class="text-xs text-slate-500">© 2026 AbsenPintar. Hak Cipta Dilindungi.</p>
            </div>
        </div>
    </div>
</div>
