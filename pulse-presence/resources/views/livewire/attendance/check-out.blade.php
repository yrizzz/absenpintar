<div class="py-6 min-h-screen text-slate-100 bg-transparent" x-data="checkOutApp()" x-init="init()" x-on:destroy="destroy()">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-6">
            ...
            <div class="lg:col-span-5 order-1 lg:order-2 space-y-6">
                ...
                <div class="bg-[#121c32]/85 border border-white/10 rounded-xl p-5 shadow-2xl space-y-5 backdrop-blur-md">
                    ...
                    <div class="flex items-center justify-between border-b border-b-white/5 pb-2.5">
                        <span class="text-[10px] font-extrabold text-rose-400 uppercase tracking-wider">MATRIX VALIDASI KEHADIRAN</span>
                        <span class="text-[10px] font-mono text-slate-400 font-bold">ABSEN KELUAR</span>
                    </div>
                    ...
                    <div class="bg-[#090e1c] border border-white/5 rounded-xl p-4 space-y-3.5">
                        <div class="flex items-center justify-between">
                            ...
                            <span x-show="!$wire.selfieData && cameraActive" class="text-[9px] px-2 py-0.5 font-bold uppercase rounded bg-rose-500/20 text-rose-400 border border-rose-500/30" style="display:none;">KAMERA AKTIF</span>
                    ...
                    <div class="pt-3 border-t border-t-white/5 flex justify-center">
                        <button x-show="$wire.locationValid && $wire.faceValid" wire:click="submit" type="button"
                            class="w-full py-2.5 bg-rose-600 hover:bg-rose-500 text-white font-bold text-xs rounded-lg shadow-lg shadow-rose-500/5 transition-all flex items-center justify-center gap-1.5" style="display:none;">
            ...
            <div class="lg:col-span-7 order-2 lg:order-1 space-y-6">
                ...
                <div class="overflow-hidden rounded-xl border border-white/10 bg-[#121c32]/85 shadow-2xl relative">
                    ...
                    <div class="relative bg-slate-950 aspect-video flex items-center justify-center overflow-hidden">
                        ...
                        <div x-show="cameraActive && !isAnalyzing" class="absolute inset-0 flex flex-col items-center justify-center pointer-events-none z-10">
                            ...
                            <div class="w-12 h-12 border border-rose-500/20 rounded-full flex items-center justify-center relative animate-pulse-subtle">
                                <div class="w-2 h-2 bg-rose-400/40 rounded-full"></div>
                                <div class="absolute inset-0 border border-rose-400/10 rounded-full scale-125"></div>
                            </div>
                            <div class="absolute bottom-4 text-[9px] font-extrabold text-rose-300 tracking-widest uppercase bg-slate-950/85 px-3.5 py-1.5 rounded-full border border-rose-500/30 shadow-lg shadow-rose-950/40">
                                Posisikan Wajah Di Sini
                            </div>
                        </div>

                        <!-- Holographic Target Grid -->
                        <div x-show="cameraActive && !isAnalyzing" class="absolute inset-0 border-[3px] border-rose-500/20 pointer-events-none z-10 m-4 rounded-xl flex items-center justify-center">
                            <!-- Glowing Scanner line in idle -->
                            <div class="absolute inset-x-4 h-[1.5px] bg-gradient-to-r from-transparent via-rose-400/30 to-transparent animate-scan z-10"></div>
                            <!-- Bounding corners -->
                            <div class="absolute top-0 left-0 w-6 h-6 border-t-[3px] border-l-[3px] border-rose-450 rounded-tl-sm"></div>
                            <div class="absolute top-0 right-0 w-6 h-6 border-t-[3px] border-r-[3px] border-rose-450 rounded-tr-sm"></div>
                            <div class="absolute bottom-0 left-0 w-6 h-6 border-b-[3px] border-l-[3px] border-rose-450 rounded-bl-sm"></div>
                    ...
                    <div class="p-4 bg-[#17243e]/30 border-t border-t-white/5 flex flex-col sm:flex-row items-center justify-between gap-3">
                        ...
                        <div class="flex-shrink-0 w-full sm:w-auto">
                            ...
                            <div 
                                x-show="cameraActive" 
                                class="w-full sm:w-auto px-5 py-2.5 bg-gradient-to-r from-rose-600/10 to-red-600/10 border border-rose-500/30 text-rose-400 font-extrabold text-xs rounded-xl shadow-lg flex items-center justify-center gap-2 select-none">
                                <span class="relative flex h-2 w-2">
                                    <span :class="isAnalyzing ? 'animate-ping' : ''" class="absolute inline-flex h-full w-full rounded-full bg-rose-400 opacity-75"></span>
                                    <span class="relative inline-flex rounded-full h-2 w-2" :class="isAnalyzing ? 'bg-rose-400' : 'bg-rose-500'"></span>
                                </span>
                ...
                <div wire:ignore class="overflow-hidden rounded-xl border border-white/10 bg-[#121c32]/85 shadow-2xl relative">
                    <div class="px-4 py-3.5 border-b border-b-white/5 bg-[#17243e]/50 flex items-center justify-between">
                        <span class="text-[10px] font-bold text-rose-455 flex items-center">
    ...
    <div x-show="$wire.isSubmitting" class="fixed inset-0 bg-[#090f1d]/90 backdrop-blur-md flex flex-col items-center justify-center z-50 transition-all duration-300" style="display: none;">
        ...
        <p class="text-xs text-slate-400 mt-1.5 animate-pulse">Mengirim data kehadiran keluar Anda ke sistem...</p>
    </div>
