<div class="py-8 min-h-screen text-slate-100 bg-transparent">
    <div class="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-8">
            ...
            <h1 class="text-3xl font-extrabold text-white tracking-tight font-display">Ruang Kerja Absen Keluar
                (Check-Out)</h1>
                ...
                <div x-data="{
                    ...
                    <div class="flex justify-end space-x-3">
                        ...
                        <button :disabled="mfaRequired && !mfaVerified" wire:click="submit"
                            ...
                            <span wire:loading.remove>Kirim Kehadiran (Check-Out)</span>
